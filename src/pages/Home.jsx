...
//               animationSpeed={3}
//               showBorder={false}
//               className="custom-class mt-10 text-5xl font-extrabold text-center"
//             >
//               Ashley Brooks
//             </GradientText>
//           </div>
...
//               {" "}
//               <a
//                 href="http://github.com/ashleyCodie "
//                 target="_blank"
//               >
  ...
  return (
    <div className="min-h-screen px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-7xl mx-auto">
        {/* Mobile-first responsive grid: 1 column on mobile, 3 on desktop */}
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8 mb-20 lg:mb-40">
          ...
          <div className="flex flex-col items-center space-y-6 lg:space-y-8">
            ...
            <div className="mt-8 lg:mt-12">
              <img
                src={ashley}
                className="h-80 border border-purple-300"
                alt="Profile Pic"
              />
            </div>
            ...
            <div className="mt-5">
              <GradientText
                ...
                animationSpeed={3}
                showBorder={false}
                className="mt-10 text-5xl font-extrabold text-center"
              >
                Ashley Brooks
              </GradientText>
            </div>
            ...
            {/* Resume Link */}
            <div className="text-3xl hover:text-purple-700 underline text-center">
              <a 
                href={resume} 
                target="_blank" 
          ...
          {/* Right Column - About Section (spans 2 columns on desktop) */}
          <div className="lg:col-span-2 mt-8 lg:mt-10 text-3xl bg-purple-300 text-center">
            <div className="m-10">
              <GradientText
                colors={["#020617", "#d8b4fe", "#9333ea", "#6d28d9", "#020617"]}
                animationSpeed={3}
                showBorder={false}
                className="text-center mt-10 text-7xl font-extrabold"
              >
                Full Stack Web Developer
              </GradientText>
              <br />
